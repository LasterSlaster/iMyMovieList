    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="https://imymovielist.firebaseapp.com/register">Registrieren
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://imymovielist.firebaseapp.com/login">Einloggen</a>
          </li>
        </ul>
      </div>
    </div>
